...
import { AppShell, ClinicalStatusBadge, DataNote, DecisionBanner, FITTVPCard, formatStatusLabel, statusTagColor, StatusTile, WorkbenchSection } from "../../../components/ProductUI";
import {
  actionStatusLabels,
  auditItemText,
  categoryOptions,
...
} from "./adminTemplateModel";
import type { ExerciseAction, KnowledgeDocument, KnowledgeEvidence, PrescriptionTemplate } from "./adminTemplateTypes";
