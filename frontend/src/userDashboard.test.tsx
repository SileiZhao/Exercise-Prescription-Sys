...
describe("user dashboard", () => {
  ...
  it("renders current risk, prescription, feedback and operation metrics", async () => {
    ...
    expect(await screen.findByText("今日安全状态")).toBeInTheDocument();
    ...
    expect(screen.getByLabelText("今日安全状态带")).toBeInTheDocument();
    ...
    expect(screen.getByText("档案完成度")).toBeInTheDocument();
