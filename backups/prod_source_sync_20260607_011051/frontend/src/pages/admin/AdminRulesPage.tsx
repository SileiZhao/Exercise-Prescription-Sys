import { Alert, Button, Card, Col, Descriptions, Divider, Drawer, Form, Input, List, Row, Select, Space, Table, Tag, Typography } from "antd";
    ...
    try {
      await updateRiskRule(ruleId, {
        ...
        condition: {
          ...
          op: values.edit_op,
          value: parseJson(values.edit_value as string, values.edit_value)
        },
              ...
              columns={[
                ...
                { title: "版本", dataIndex: "version" },
                {
                  ...
                  render: (_: unknown, record: RiskRuleItem) => (
                    <Button aria-label="查看规则详情" size="small" onClick={() => void openRuleDetail(record)}>
                      详情
                    </Button>
                  )
                }
            ...
            {selectedRule ? (
              <Space direction="vertical" size={16} style={{ width: "100%" }}>
                ...
                >
                  ...
                  <Form.Item name="edit_value" label="比较值">
                    <Input />
                  </Form.Item>
