...
import { AppShell, ClinicalScopePanel, EvidenceTimeline, FlowProgress, MotionCard, RiskBadge, RiskStatusPanel, SafetyBoundaryChecklist } from "../../components/ProductUI";
...
export function PhenotypePage() {
  ...
  const isRiskReportRoute = location.pathname === "/user/risk-result";

  return (
    <AppShell role="user" title={isRiskReportRoute ? "判定报告" : "人群分型"}>
          ...
          <Space direction="vertical" size={16} className="onboarding-section">
            ...
            >
              ...
              <div className="risk-decision-copy">
                <Typography.Text className="page-hero-eyebrow">风险判定</Typography.Text>
