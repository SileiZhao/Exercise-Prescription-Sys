...
describe("ECharts chart components", () => {
  ...
  it("uses a lower but readable chart height on narrow mobile viewports", async () => {
    ...
    try {
      ...
      const chart = await screen.findByTestId("RiskDistributionChart-echart");
      await waitFor(() => expect(chart.style.height).toBe("230px"));
    } finally {
