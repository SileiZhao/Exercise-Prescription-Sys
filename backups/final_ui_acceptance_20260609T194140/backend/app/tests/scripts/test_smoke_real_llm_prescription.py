...
def test_real_llm_smoke_output_omits_api_key_material() -> None:
    runtime = {
        "provider": "aliyun",
        "model": "qwen3.7-max",
    ...
    safe = _safe_smoke_runtime_summary(runtime)
    ...
    assert "api_key_name" not in safe
