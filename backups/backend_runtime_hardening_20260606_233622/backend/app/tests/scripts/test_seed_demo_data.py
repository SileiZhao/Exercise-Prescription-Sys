...
def test_seed_demo_data_creates_demo_accounts_samples_and_is_idempotent(db_session):
...
def test_seed_demo_data_backfills_template_bindings_for_existing_demo_prescriptions(db_session):
    seed_script = _load_seed_script()
...
def test_seed_demo_data_clear_removes_only_demo_data(db_session):
    seed_script = _load_seed_script()
