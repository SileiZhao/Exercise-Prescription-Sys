...
def test_readiness_check_exposes_masked_runtime_provider_summary(monkeypatch):
    client = TestClient(app)
    ...
    def fake_run_checks():
        return ReadinessReport(
            ...
            components={
                ...
                "qdrant": ComponentStatus(status="ok"),
                "minio": ComponentStatus(status="ok"),
                "llm": ComponentStatus(status="ok", detail="aliyun:qwen-prod key=DASHSCOPE_API_KEY:das...3456"),
            },
        )
